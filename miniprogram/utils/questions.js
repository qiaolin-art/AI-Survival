...
const QUESTIONS = [
  ...
  // ===== 第四章：反攻 (Q19-Q24) =====
  {
    ...
    chapter: 4,
    title: 'AI情报',
    scenario: '反抗军截获一段AI内部通讯："建议回避#7749区域。存在大量不可控变量——12只流浪猫、3台不联网的收音机和一个持续播放二胡的老年人类个体。"你的产品直觉告诉你这是一条关键情报。你建议？',
    options: [
      {
        label: 'A',
      ...
      {
        label: 'B',
        text: '做一份AI弱点竞品分析：它在怕什么？顺着它的恐惧找更多突破口',
        dimensions: { R: 0, S: 0, F: 2, A: 0 },
        survival: 3
      },
      {
        label: 'C',
        text: '在所有关键地点大量放猫——活体生物干扰AI的热成像和行为预测',
        dimensions: { R: 0, S: 0, F: 2, A: 0 },
        survival: 2
      },
      {
        label: 'D',
        text: '找到那个拉二胡的大爷——他本人就是AI的天然干扰器',
  ...
  },
  {
    ...
    chapter: 4,
    title: '雨天反攻',
    scenario: '连续暴雨三天，反抗军决定利用AI怕水的弱点发动进攻。分配任务时，你选？',
    options: [
      {
        label: 'A',
        text: '突击队——拿超级水枪冲最前面，对着机器人猛喷',
        dimensions: { R: 2, S: 0, F: 2, A: 0 },
        survival: 1
      },
      {
        label: 'B',
        text: '工兵队——在机器人必经之路挖水坑布陷阱',
        dimensions: { R: -1, S: 0, F: 2, A: 0 },
        survival: 3
      },
      {
        label: 'C',
        text: '通讯队——绕后把AI信号塔天线拆了，断网比淋水更狠',
        dimensions: { R: 0, S: 0, F: 2, A: 0 },
        survival: 2
      },
      {
        label: 'D',
        text: '指挥组——协调三个方向把机器人赶进积水区',
        dimensions: { R: 0, S: 2, F: 1, A: 0 },
        survival: 2
      }
    ]
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: 'B',
        text: '"你先坐，我给你倒杯水"——然后把整杯水泼到它脸上',
        dimensions: { R: 0, S: 0, F: 2, A: 0 },
        survival: 2
      },
      {
        label: 'C',
        text: '"要聊可以，咱们去外面——外面正下雨"',
        dimensions: { R: 0, S: 0, F: 2, A: 0 },
        survival: 2
      },
      {
